...
const mocks = vi.hoisted(() => ({
  ...
  updatePreventiveWithAudit: vi.fn(async (id: number, data: any) => ({ id, ...data })),
  cancelPreventive: vi.fn(async (id: number) => ({ id, status: "Cancelada" })),
  listPreventiveAuditLogs: vi.fn(async () => []),
